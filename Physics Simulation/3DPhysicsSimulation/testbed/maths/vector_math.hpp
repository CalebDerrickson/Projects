...
namespace vector {
    ...
    // vec3
    template<typename T, typename S>
    T dot(const vec3<T>& vec1, const vec3<S>& vec2) {
        return vec1.x * vec2.x + vec1.y * vec2.y + vec1.z * vec2.z;
    }

    template<typename T, typename S>
    vec3<T> haddamard(const vec3<T>& vec1, const vec3<S>& vec2) {
    ...
    // vec2
    template<typename T, typename S>
    T dot(const vec2<T>& vec1, const vec2<S>& vec2) {
        return vec1.x * vec2.x + vec1.y * vec2.y;
    }

    template<typename T>
    vec2<T> hadamard(const vec2<T>& vec1, const vec2<T>& vec2) {
        return {vec1.x * vec2.x, vec1.y * vec2.y};
    }

    template <typename T>
    vec3<T> cross(const vec2<T>& vec1, const vec2<T>& vec2) {
        return {
            0,
            0,
            vec1.x * vec2.y - vec1.y * vec2.x
